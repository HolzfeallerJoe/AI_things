                        ...
                        children: [
                          if (task.isRecurring)
                            Text(
                              ...
                              style:
                                  TextStyle(fontSize: 12, color: theme.inkSoft),
                            ),
                          if (overdue)
                            Text(
                              'seit ${formatDate(task.startDate)} offen',
                              style: TextStyle(
...
Future<void> showTaskSheet(BuildContext context,
    {Task? task, DateTime? initialDate}) {
  final state = AppScope.of(context);
  final theme = joeThemeOf(context);
        ...
        child: Column(
          ...
          children: [
            Text(
              ...
              style: TextStyle(
                  fontSize: 18, fontWeight: FontWeight.w700, color: theme.ink),
            ),
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () => setSheetState(() =>
                          intervalDays = intervalDays > 2 ? intervalDays - 1 : 2),
                    ),
                    Text('$intervalDays',
                        style: TextStyle(
                            color: theme.ink, fontWeight: FontWeight.w700)),
                    IconButton(
...
Future<void> showAppointmentSheet(BuildContext context,
    {Appointment? appointment, DateTime? initialDate}) {
  final state = AppScope.of(context);
  final theme = joeThemeOf(context);
    ...
    builder: (sheetContext) => StatefulBuilder(
      builder: (sheetContext, setSheetState) => Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              appointment == null ? 'Neuer Termin' : 'Termin bearbeiten',
              style: TextStyle(
                  fontSize: 18, fontWeight: FontWeight.w700, color: theme.ink),
            ),
            const SizedBox(height: 12),
