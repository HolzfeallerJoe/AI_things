...
export interface VectorBase extends BaseNode {
  ...
  fills?: Paint[];
  fillGeometry?: Path[];
  fillOverrideTable?: Record<number, { fills: Paint[] }>;
  strokes?: Paint[];
  strokeWeight?: number;
...
export interface FileNodesResponse {
  ...
  thumbnailUrl?: string;
  version: string;
  nodes: Record<string, { document: SceneNode; components: Record<string, Component>; schemaVersion: number; styles: Record<string, Style> } | null>;
}
